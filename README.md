...
A **client-side** mod for **NeoForge and Fabric** on **Minecraft 1.21.1 through 26.3** (26.3 on Fabric only for now)
...
One source tree is built into fifteen jars — seven Minecraft versions times two
mod loaders, plus 26.3 on Fabric alone — by [Stonecutter](https://stonecutter.kikugie.dev), with
...
3. Run `./gradlew buildAll testAll` to make sure all fifteen targets compile and
