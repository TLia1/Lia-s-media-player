...
| `Theme.java`                                                                                | The whole palette, named by role (`WINDOW_BG`, `ROW_HOVER_BG`, `ICON_HOVER`, `DANGER`, …). Every window, panel, list and overlay reads its colours from here instead of declaring its own constants, so the look is defined in one file.                                                                                                                                                                                       |
